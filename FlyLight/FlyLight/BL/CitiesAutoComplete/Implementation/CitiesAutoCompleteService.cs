...
{
    public class CitiesAutoCompleteService : ReactiveObject, ICitiesAutoCompleteService
    {
        public CitiesAutoCompleteService(ICitiesAutoCompleteReadFacade citiesReadFacade)
        {
            ...
            SearchCityCommand = ReactiveCommand.CreateAsyncTask(
                ...
                async _ =>
                    await citiesReadFacade.GetCities(City, "en")
                );
        ...
        private IReactiveList<string> _citiesOptions;
        ...
        public ReactiveCommand<List<string>> SearchCityCommand { get; private set; }
    }
}